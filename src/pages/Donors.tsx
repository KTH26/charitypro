        ...
        complete: (results) => {
          ...
          data.forEach(row => {
            ...
            const donorUpdates = {
              ...
              displayId,
              hebFirstName: row['Hebrew First Name (ערשטע נאמען)']?.toString().trim() || row['ערשטע נאמען']?.toString().trim() || '',
              hebLastName: row['Hebrew Last Name (משפחה נאמען)']?.toString().trim() || row['משפחה נאמען']?.toString().trim() || '',
              preTitle: row['Pre-Title (פאר טיטל)']?.toString().trim() || (row['title'] ?? row['Title'] ?? row[' title'])?.toString().trim() || '',
              title: row['Title (טיטל)']?.toString().trim() || row['טיטל']?.toString().trim() || '',
