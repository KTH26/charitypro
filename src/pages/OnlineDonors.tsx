    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg)', padding: 28, fontFamily: 'Inter, sans-serif' }}>
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 20, alignItems: 'center', marginBottom: 22 }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end' }}><button className="btn btn-primary" onClick={() => { setEditing('new'); setNotice(''); }}>Add Donor</button><a className="btn btn-secondary" href="/payments">Payments</a><a className="btn btn-secondary" href="/expenses">Expenses</a><a className="btn btn-secondary" href="/bank-feed">Bank</a><a className="btn btn-secondary" href="/chart-of-accounts">Accounts</a><a className="btn btn-secondary" href="/legacy/donors">Legacy Tools</a></div>
        </div>
